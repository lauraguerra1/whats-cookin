...
const getRecipeCard = (recipe) => {
  const recipeCard =  {
    id: recipe.id,
    instructions: (0,_recipes__WEBPACK_IMPORTED_MODULE_2__.getInstructions)(recipe),
    ingredients: (0,_recipes__WEBPACK_IMPORTED_MODULE_2__.getIngredientAmounts)(recipe, _apiCalls__WEBPACK_IMPORTED_MODULE_30__.pageData.allIngredients),
    image: recipe.image,
    name: recipe.name,
    price: (0,_recipes__WEBPACK_IMPORTED_MODULE_2__.calculateRecipeCost)(recipe, _apiCalls__WEBPACK_IMPORTED_MODULE_30__.pageData.allIngredients),
    tags: recipe.tags
  }
...
const getPageRecipes = () => {
  ...
  return data[_apiCalls__WEBPACK_IMPORTED_MODULE_30__.pageData.currentView];
}

window.addEventListener("load", () => {
  ;(0,_apiCalls__WEBPACK_IMPORTED_MODULE_30__.loadData)();
});

window.addEventListener('resize', () => {
  (0,_domUpdates__WEBPACK_IMPORTED_MODULE_1__.renderGrid)(_apiCalls__WEBPACK_IMPORTED_MODULE_30__.pageData.recipesOfInterest)
})

allRecipes.addEventListener('click', (event) => {
  if (event.target.classList.contains("save-option")) {
    (0,_domUpdates__WEBPACK_IMPORTED_MODULE_1__.updateRecipesFromGrid)(event);
  }
})

modalRecipeBtns.forEach(btn => {
  btn.addEventListener('click', (e) => {
    ;(0,_domUpdates__WEBPACK_IMPORTED_MODULE_1__.updateRecipesFromModal)(e);
  })
...
tagArea.addEventListener("click", function(event) {
  if (event.target.classList && event.target.closest(".tag-card")) {
    (0,_domUpdates__WEBPACK_IMPORTED_MODULE_1__.toggleTagData)(event.target.closest("section").id);
    (0,_domUpdates__WEBPACK_IMPORTED_MODULE_1__.renderActiveTag)(event);
    (0,_domUpdates__WEBPACK_IMPORTED_MODULE_1__.displayTaggedRecipes)();
  };
});
...
recipeGrid.addEventListener("click", (event) => {
  if (event.target.classList?.contains('individual-recipe') && !(0,_domUpdates__WEBPACK_IMPORTED_MODULE_1__.checkIfModalOpen)()) {
    (0,_domUpdates__WEBPACK_IMPORTED_MODULE_1__.showRecipe)(event.target);
  }
});
...
recipeGrid.addEventListener("mouseover", (event) => {
  if (event.target.classList?.contains('individual-recipe')) {
    (0,_domUpdates__WEBPACK_IMPORTED_MODULE_1__.enableScrollPitchText)(event.target.querySelector('h4'));
  }
});

closeButtons.forEach(button => {
  button.addEventListener("click", (e) => {
    (0,_domUpdates__WEBPACK_IMPORTED_MODULE_1__.closePanel)(e);
  })
...
chooseView.addEventListener("click", function(event) {
  if (event.target.classList.contains("unselected-view")) {
    (0,_domUpdates__WEBPACK_IMPORTED_MODULE_1__.switchView)(event.target.id);
  }
});
...
searchBar.addEventListener('search', (event) => {
  if (!event.target.value.length) {
    ...
    (0,_domUpdates__WEBPACK_IMPORTED_MODULE_1__.searchForRecipes)();
  }
})

searchBtn.addEventListener('click', _domUpdates__WEBPACK_IMPORTED_MODULE_1__.searchForRecipes);
whatsCookin.addEventListener('click', _domUpdates__WEBPACK_IMPORTED_MODULE_1__.resetSearch);

refreshBtn.addEventListener('click', _domUpdates__WEBPACK_IMPORTED_MODULE_1__.resetSearch);

refreshBtn.addEventListener('keyup', (e) => {
  if (e.key === 'Enter') {
    (0,_domUpdates__WEBPACK_IMPORTED_MODULE_1__.resetSearch)();
  }
})

graphBtn.addEventListener('click', (e) => {
  ;(0,_domUpdates__WEBPACK_IMPORTED_MODULE_1__.openInfoPanel)(e.target);
});
...
const createSingleRecipeHTML = singleRecipe => {
  ...
  if(_apiCalls__WEBPACK_IMPORTED_MODULE_0__.currentUser?.recipesToCook){
    if((0,_recipes__WEBPACK_IMPORTED_MODULE_2__.checkSavedStatus)(_apiCalls__WEBPACK_IMPORTED_MODULE_0__.currentUser, singleRecipe.id)) {
      addStatus = 'hidden';
      removeStatus = '';
    }
  }
...
const updateIngredientLayout = () => {
  if(window.innerWidth < 1000) {
    ...
    _scripts__WEBPACK_IMPORTED_MODULE_1__.ingredientsList.classList.remove('scrollbar')
  }
}

const renderGrid = (data) => {
  const gridData = makeRecipeColumnData(data);
  _scripts__WEBPACK_IMPORTED_MODULE_1__.recipeGrid.innerHTML = '';
  _scripts__WEBPACK_IMPORTED_MODULE_1__.recipeGrid.innerHTML = createGridHTML(gridData);
...
const renderTagArea = () => {
  let htmlCode = '';
  _apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.allTags.forEach(tag => {
    htmlCode += createTagCardHTML(tag)
  })
  _scripts__WEBPACK_IMPORTED_MODULE_1__.tagArea.innerHTML = htmlCode;
};
...
const toggleTagData = (tagID) => {
  _apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.allTags.find(tag => tag.name === tagID).isActive = !_apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.allTags.find(tag => tag.name === tagID).isActive
}

const pageLoadRenders = (data) => {
  renderGrid(data);
  renderTagArea();
  [_scripts__WEBPACK_IMPORTED_MODULE_1__.leftArrow, _scripts__WEBPACK_IMPORTED_MODULE_1__.rightArrow].forEach(arrow => arrow.classList.remove('hidden'))
};
...
const updateCurrentRecipe = recipeCard => {
  ...
  const thisRecipe = (0,_recipes__WEBPACK_IMPORTED_MODULE_2__.findRecipe)(_apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.allRecipes, recipeCardID);
  _apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.currentRecipeCard = (0,_scripts__WEBPACK_IMPORTED_MODULE_1__.getRecipeCard)(thisRecipe);
  _apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.currentRecipeCard.outerAddBtn = recipeCard?.closest('.individual-recipe-container').querySelector('.add-panel');
  _apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.currentRecipeCard.outerRemoveBtn = recipeCard?.closest('.individual-recipe-container').querySelector('.remove-panel');
}
...
const showFeedback = (user, recipeID) => {
    ...
    if ((0,_recipes__WEBPACK_IMPORTED_MODULE_2__.checkSavedStatus)(user, recipeID)) {
      feedback = "Saved"
    } else {
      feedback = "Removed"
    }
...
const populateRecipeHeader = currentRecipe => {
  let filteredTags = (0,_recipes__WEBPACK_IMPORTED_MODULE_2__.filterTagsByTagName)(_apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.allTags, currentRecipe.tags);
...
const openInfoPanel = (infoType) => {
  ...
  if (infoType.id === 'graphButton') {
    thisPanel = _scripts__WEBPACK_IMPORTED_MODULE_1__.graphPanel;
    thisPanel.classList.toggle('hidden');
    (0,_clickChart__WEBPACK_IMPORTED_MODULE_4__.makeRecipeClickChart)();
    document.querySelector('#closeGraphBtn').focus()
  } else {
    thisPanel = _scripts__WEBPACK_IMPORTED_MODULE_1__.clickedRecipe;
    thisPanel.classList.toggle('hidden');
  ...
  _scripts__WEBPACK_IMPORTED_MODULE_1__.allRecipes.classList.add('blur', 'no-click');
  _scripts__WEBPACK_IMPORTED_MODULE_1__.nav.classList.add('blur', 'no-click');
  _scripts__WEBPACK_IMPORTED_MODULE_1__.body.classList.add('no-scroll');
}

const closePanel = (e) => {
  clearTimeout(timerID);
  const thisInfoPanel = e.target.closest('.info-panel');
  _scripts__WEBPACK_IMPORTED_MODULE_1__.allRecipes.classList.remove('blur', 'no-click')
  _scripts__WEBPACK_IMPORTED_MODULE_1__.nav.classList.remove('blur', 'no-click');
  _scripts__WEBPACK_IMPORTED_MODULE_1__.body.classList.remove('no-scroll')
...
const renderRecipesOfInterest = () => {
  _apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.recipesOfInterest = (0,_helper_functions__WEBPACK_IMPORTED_MODULE_5__.copyItem)((0,_scripts__WEBPACK_IMPORTED_MODULE_1__.getPageRecipes)());
  renderGrid(_apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.recipesOfInterest);
}
...
const switchView = (clickedViewID) => {
  setAllTagsInactive();
  renderTagArea();
  if (clickedViewID !== _apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.currentView) {
    (0,_helper_functions__WEBPACK_IMPORTED_MODULE_5__.toggleViewBtns)([_scripts__WEBPACK_IMPORTED_MODULE_1__.ourViewBtn, _scripts__WEBPACK_IMPORTED_MODULE_1__.yourViewBtn]);
    _apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.currentView = clickedViewID;
  }
  renderRecipesOfInterest();
}

const setBaseData = () => {
  let baseData = (0,_scripts__WEBPACK_IMPORTED_MODULE_1__.getPageRecipes)();
  if (_scripts__WEBPACK_IMPORTED_MODULE_1__.searchBar.value) {
    searchForRecipes();
    baseData = _apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.recipesOfInterest;
  }
  return baseData;
}
...
const setupFilterData = (activeTags, baseData) => {
  if (activeTags.length) {
    return (0,_recipes__WEBPACK_IMPORTED_MODULE_2__.filterRecipesByTag)(baseData, activeTags);
  } else {
    return (0,_helper_functions__WEBPACK_IMPORTED_MODULE_5__.copyItem)((0,_scripts__WEBPACK_IMPORTED_MODULE_1__.getPageRecipes)());
  }
}

const displayTaggedRecipes = () => {
  const activeTags = _apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.allTags.filter(tag => tag.isActive).map(tag => tag.name);
  const baseData = setBaseData();
  const filteredRecipes = setupFilterData(activeTags, baseData);
  if (filteredRecipes.length) {
    _apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.recipesOfInterest = filteredRecipes;
    renderGrid(_apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.recipesOfInterest)
  } else {
    _scripts__WEBPACK_IMPORTED_MODULE_1__.recipeGrid.innerHTML = `<p>Sorry, no recipes to display.</p>`
  }
}

const searchForRecipes = () => {
  const activeTags = _apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.allTags.filter(tag => tag.isActive).map(tag => tag.name);
  let searchedRecipes = (0,_recipes__WEBPACK_IMPORTED_MODULE_2__.searchRecipes)(setupFilterData(activeTags, (0,_scripts__WEBPACK_IMPORTED_MODULE_1__.getPageRecipes)()), _apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.allIngredients, _scripts__WEBPACK_IMPORTED_MODULE_1__.searchBar.value);
  if(searchedRecipes) {
    if (searchedRecipes.length) {
      _apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.recipesOfInterest = searchedRecipes;
      renderGrid(searchedRecipes);
    } else {
      _scripts__WEBPACK_IMPORTED_MODULE_1__.recipeGrid.innerHTML = `<p>Sorry, we couldn't find any recipes for your search of "${_scripts__WEBPACK_IMPORTED_MODULE_1__.searchBar.value}"</p>`;
    }
  }
}

const resetSearch = () => {
  _scripts__WEBPACK_IMPORTED_MODULE_1__.searchBar.value = '';
  switchView(_apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.currentView);
}

const renderTagsAfterFetch = () => {
  const activeTags = _apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.allTags.filter(tag => tag.isActive);
  if(activeTags.length) {
    displayTaggedRecipes();
  } else if(_apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.currentView === 'your-recipes') {
    renderRecipesOfInterest();
  }
}
...
const updateRecipesFromGrid = (e) => {
  if (e.target.classList.contains('save-option')) {
    ...
    const recipe = (0,_recipes__WEBPACK_IMPORTED_MODULE_2__.findRecipe)(_apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.allRecipes, recipeID);
    if (!(0,_recipes__WEBPACK_IMPORTED_MODULE_2__.checkSavedStatus)(_apiCalls__WEBPACK_IMPORTED_MODULE_0__.currentUser, recipeID)) {
      (0,_users__WEBPACK_IMPORTED_MODULE_3__.updateRecipesToCook)(e, recipe, 'add');
    } else if ((0,_recipes__WEBPACK_IMPORTED_MODULE_2__.checkSavedStatus)(_apiCalls__WEBPACK_IMPORTED_MODULE_0__.currentUser, recipeID)) {
      (0,_users__WEBPACK_IMPORTED_MODULE_3__.updateRecipesToCook)(e, recipe, 'remove');
    }
  } 
}
...
const updateRecipesFromModal = (e) => {
  if (e.target.classList.contains('modal-btn')) {
    ...
    const recipeID = _apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.currentRecipeCard.id;
    const recipe = (0,_recipes__WEBPACK_IMPORTED_MODULE_2__.findRecipe)(_apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.allRecipes, recipeID);
    (0,_users__WEBPACK_IMPORTED_MODULE_3__.updateRecipesToCook)(e, recipe, change);
  }
}

const checkIfModalOpen = () => _scripts__WEBPACK_IMPORTED_MODULE_1__.allRecipes.classList.contains('blur')
...
const toggleSavedButtons = (e, recipeID, user) => {
  if (checkIfModalOpen()) {
    const outerAdd = _apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.currentRecipeCard.outerAddBtn;
    const outerRemove = _apiCalls__WEBPACK_IMPORTED_MODULE_0__.pageData.currentRecipeCard.outerRemoveBtn;
    updateSaveButtons(recipeID, outerAdd, outerRemove, user);
    updateSaveButtons(recipeID, _scripts__WEBPACK_IMPORTED_MODULE_1__.modalAddBtn, _scripts__WEBPACK_IMPORTED_MODULE_1__.modalRemoveBtn, user);
  } else {
...
const hideSpinner = () => {
  _scripts__WEBPACK_IMPORTED_MODULE_1__.spinner.classList.add('hidden');
}
...
const getUsersAfterUpdate = (userID, recipeID, e, errorMessage) => {
  return getUsers()
          ...
          .then(data => {
            ...
            (0,_domUpdates__WEBPACK_IMPORTED_MODULE_1__.renderTagsAfterFetch)();
            (0,_domUpdates__WEBPACK_IMPORTED_MODULE_1__.toggleSavedButtons)(e, recipeID, currentUser, errorMessage);
            (0,_domUpdates__WEBPACK_IMPORTED_MODULE_1__.showFeedback)(currentUser, recipeID)
          })
          .catch(err => console.error(err));
}

const handleUserData = users => currentUser = (0,_users__WEBPACK_IMPORTED_MODULE_0__.getRandomUser)(users);
...
const preparePageRender = () => {
  pageData.recipesOfInterest = (0,_helper_functions__WEBPACK_IMPORTED_MODULE_2__.copyItem)(pageData.allRecipes);
  pageData.allTags = (0,_recipes__WEBPACK_IMPORTED_MODULE_3__.populateTags)(pageData.allRecipes);
  (0,_domUpdates__WEBPACK_IMPORTED_MODULE_1__.hideSpinner)();
  (0,_domUpdates__WEBPACK_IMPORTED_MODULE_1__.pageLoadRenders)(pageData.allRecipes);
}
...
const updateServerRecipe = (userID, recipeID, e, requestType) => {
  ...
  .then(status => {
    if (status.message.includes(`was ${conditions[requestType]}`)) {
      ...
      (0,_domUpdates__WEBPACK_IMPORTED_MODULE_1__.showError)(recipeID)
    }
  })
  .catch(err => {
    (0,_domUpdates__WEBPACK_IMPORTED_MODULE_1__.showError)(recipeID);
...
const getRandomUser = users => {
  return users[(0,_helper_functions__WEBPACK_IMPORTED_MODULE_0__.getRandomIndex)(users)]
}

const addUniqueRecipe = (userRecipes, newRecipe, e) => {
  if(!userRecipes.find(recipeID => recipeID.toString() === newRecipe.id.toString())) {
    (0,_apiCalls__WEBPACK_IMPORTED_MODULE_1__.updateServerRecipe)(_apiCalls__WEBPACK_IMPORTED_MODULE_1__.currentUser.id, newRecipe.id, e, "POST");
  }
};
...
const removeExistingRecipe = (userRecipes, recipeToRemove, e) => {
  ...
  if (found) {
    (0,_apiCalls__WEBPACK_IMPORTED_MODULE_1__.updateServerRecipe)(_apiCalls__WEBPACK_IMPORTED_MODULE_1__.currentUser.id, recipeToRemove.id, e, "DELETE")
  }
}

const updateRecipesToCook = (e, recipe, change) => {
  let userRecipes = _apiCalls__WEBPACK_IMPORTED_MODULE_1__.currentUser.recipesToCook;
  let recipeUpdate = {
...
const getIngredients = (recipe, ingredients) => {
  return recipe.ingredients.map(ingredient => (0,_helper_functions__WEBPACK_IMPORTED_MODULE_0__.getIngredientProperty)(ingredient, ingredients, 'name'))
}
...
const getIngredientAmounts = (recipe, ingredients) => {
  return recipe.ingredients.map(ingredient => {
    return {
      ...
      name: (0,_helper_functions__WEBPACK_IMPORTED_MODULE_0__.getIngredientProperty)(ingredient, ingredients, 'name')
    }
  })
}
...
const calculateRecipeCost = (recipe, ingredients) => {
  const recipeIngredients = recipe.ingredients.map(ingredient => ({amount: ingredient.quantity.amount, costPerUnit: (0,_helper_functions__WEBPACK_IMPORTED_MODULE_0__.getIngredientProperty)(ingredient, ingredients, 'estimatedCostInCents')}))
...
const sortByHits = recipes => {
  let copiedRecipes = (0,_helper_functions__WEBPACK_IMPORTED_MODULE_0__.copyItem)(recipes);
...
const makeRecipeClickChart = () => {
    ...
    const sortedRecipes = (0,_recipes__WEBPACK_IMPORTED_MODULE_2__.sortByHits)(_apiCalls__WEBPACK_IMPORTED_MODULE_1__.pageData.allRecipes).slice(0, 10);
    new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](document.querySelector('#clickChart'),
        {
            type: 'bar',
            data: {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("images/select-bookmark-icon.png");
